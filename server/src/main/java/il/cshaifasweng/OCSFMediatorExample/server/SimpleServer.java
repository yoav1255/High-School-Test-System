		...
		try {
			...
			switch (msgString){
				...
				case ("#SendIdToExamForms"):
					System.out.println("In simple server send id to exam forms "+message.getData().toString());
					client.sendToClient(new CustomMessage("returnIdToPage",message.getData().toString()));
				case ("#getSubjects"):
